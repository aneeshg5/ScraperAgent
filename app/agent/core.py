...
from app.models.schemas import ScreenshotData
...
async def multimodal_research_agent(
    ...
    try:
        ...
        # Step 6: Prepare screenshot data for frontend display  
        screenshot_data = []
        if include_screenshots and screenshots:
                ...
                if screenshot_bytes:
                    try:
                        ...
                        screenshot_info = ScreenshotData(
                            ...
                            width=1280,  # Default dimensions - could be extracted from image if needed
                            height=720
                        )
                        screenshot_data.append(screenshot_info)
                        
                    except Exception as e:
                        logger.warning(f"Failed to encode screenshot {i}: {e}")
